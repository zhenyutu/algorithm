 ...
 * @author tuzhenyu
 */
public class ExchangeCoinsMethod {
    public int exchange0(int[] arr,int arm){
     ...
     * @return
     */
    public int exchange1(int[] arr,int arm){
        if (arr==null||arr.length==0||arm<0)
            return -1;
     ...
     * @return
     */
    public int exchange2(int[] arr,int arm){
        if (arr==null||arr.length==0||arm<0)
            return -1;
     ...
     * @return
     */
    public int exchange3(int[] arr,int arm){
        if (arr==null||arr.length==0||arm<0)
            return -1;
    ...
    public int exchange4(int[] arr,int arm){
        if (arr==null||arr.length==0||arm<0)
            return -1;
        int[][] dp = new int[arr.length][arm+1];
